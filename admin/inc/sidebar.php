    ...
    <ul class="sidebar-menu" id="sidebar-menu">
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          ...
          <li>
            <a href="index.php"><i class="ri-circle-fill circle-icon text-success-main w-auto"></i> Ananlytics</a>
          </li>
        </ul>
      </li>
      ...
      <li class="dropdown">
        ...
        <ul class="sidebar-submenu">
          <li>
            <a href="rider-assign.php"><i class="ri-circle-fill circle-icon text-primary-600 w-auto"></i>Assign Rider</a>
          </li>
          <li>
      ...
      <li class="dropdown">
        <a href="javascript:void(0)">
          <iconify-icon icon="token-branded:xdata" class="menu-icon"></iconify-icon>
